package com.example.tmdbclientapp.model;
...
public class Movie extends BaseObservable implements Parcelable
{
    ...
    public static void loadImage(ImageView imageView, String posterURL) {
        String imagePath = imageView.getContext().getResources().getString(R.string.image_base_url) + posterURL;
    ...
    public static final DiffUtil.ItemCallback<Movie> CALLBACK = new DiffUtil.ItemCallback<Movie>() {
        ...
        public boolean areContentsTheSame(@NonNull Movie oldItem, @NonNull Movie newItem) {
            //Here we will have two compare two 'Movie' instance variables.
            return true;
        }
    };
}